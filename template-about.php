	...
	<div id="primary">
		<div id="content" role="main">
			...
			<div id="about_video_frame">
			 <img id="about_intro_img" src="<?php the_field('intro_image');?>" alt="We are Loupe Theory, we tell your story. What sets us apart? We care. We collaborate. We keep our word.  From start to finish we strive for excellence and take great pride in our work.  We do this because we know you do too." width="961" height="346"/>
        <iframe id="about_intro"  class="vimeo" src="<?php the_field('intro_video');?>?api=1&amp;player_id=about_intro&amp;title=0&amp;byline=0&amp;portrait=0" width="960" height="346" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
      </div><!-- about_video_frame -->
  ...
  <div id="fun_facts_wrapper">
    ...
    <div id="fun_facts">
      ...
      <div id="facts2" class="facts">
        ...
        <img src="<?php bloginfo('template_directory'); ?>/images/five-clocks.png" alt="At Loupe Theory, we know our stuff and we’re great at what we do. Over 15 years in the biz" />
        </div><!-- .facts_content -->
      </div><!-- #facts2 -->
      <div id="facts3" class="facts last">
      <div class="facts_content" style="display:none;">
        <span>We are based out of</span> Baton Rouge.<br><em>Southern hospitality at its finest</em>        <img src="<?php bloginfo('template_directory'); ?>/images/loupe-theory-baton-rouge-louisiana.png" alt="At Loupe Theory, we provide southern hospitality at its finest" />
        </div><!-- .facts_content -->
      </div><!-- #facts3 -->
    </div>
  </div>
